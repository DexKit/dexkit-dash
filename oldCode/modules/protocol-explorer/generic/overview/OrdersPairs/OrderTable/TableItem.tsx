...
import { CustomRedirect } from 'modules/protocol-explorer/generic/CustomRedirect';
  ...
  return (
    <TableRow className={classes.borderBottomClass}>
      ...
      <TableCell align='left' className={classes.tableCell}>
        <CustomRedirect to={`/protocol-explorer/uniswap/token-explorer/${row.sellToken.address}`}>
      ...
      <TableCell align='left' className={classes.tableCell}>
        <CustomRedirect to={`/protocol-explorer/uniswap/token-explorer/${row.buyToken.address}`}>
        {row.buyToken.symbol}
        </CustomRedirect>
      </TableCell>
