...
import { GetMyBalance, GetMyBalanceVariables } from "services/graphql/bitquery/balance/__generated__/GetMyBalance";
...
export const useTokenBalancesAffiliate = (affiliateAccount: string) => {
    ...
    const {data, loading, error} = useQuery<GetMyBalance, GetMyBalanceVariables >(BITQUERY_BALANCE_INFO, {variables, skip} )
