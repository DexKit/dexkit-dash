...
export interface GetPairTrades_ethereum_dexTrades_block {
   ...
   * Block timestamp
   */
  timestamp: GetPairTrades_ethereum_dexTrades_block_timestamp | null;
  /**
...
export interface GetPairTrades_ethereum_dexTrades_smartContract {
   ...
   */
  address: GetPairTrades_ethereum_dexTrades_smartContract_address;
}
...
export interface GetPairTrades_ethereum_dexTrades {
   ...
   * Time interval
   */
  timeInterval: GetPairTrades_ethereum_dexTrades_timeInterval | null;
  /**
   * Calendar date
   */
  date: GetPairTrades_ethereum_dexTrades_date | null;
  /**
   * Block in the blockchain
   */
  block: GetPairTrades_ethereum_dexTrades_block | null;
  /**
   ...
   */
  exchange: GetPairTrades_ethereum_dexTrades_exchange | null;
  /**
   * Smart contract being called
   */
  smartContract: GetPairTrades_ethereum_dexTrades_smartContract | null;
  /**
   * Transaction of DexTrade
   */
  transaction: GetPairTrades_ethereum_dexTrades_transaction | null;
  baseAmount: number | null;
  baseAmountInUsd: number | null;
  /**
   * Base currency
   */
  baseCurrency: GetPairTrades_ethereum_dexTrades_baseCurrency | null;
  quoteAmount: number | null;
  quoteAmountInUsd: number | null;
  /**
   * Quote currency
   */
  quoteCurrency: GetPairTrades_ethereum_dexTrades_quoteCurrency | null;
...
export interface GetPairTrades_ethereum {
   ...
   */
  dexTrades: GetPairTrades_ethereum_dexTrades[] | null;
}

export interface GetPairTrades {
  /**
   * Ethereum Mainnet / Classic Chain Datasets
   */
  ethereum: GetPairTrades_ethereum | null;
}

export interface GetPairTradesVariables {
