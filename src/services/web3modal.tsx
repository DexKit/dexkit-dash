  ...
  'custom-magiclink': {
    ...
    connector: async (ProviderPackage: Magic, options: any) => {
      ...
      await magic.oauth.loginWithRedirect({
        ...
        redirectURI: 'https://app.dexkit.com',
      });
