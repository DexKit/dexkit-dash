...
import { Grow, IconButton, makeStyles, Popover, PopoverProps, Typography } from '@material-ui/core';
...
export interface PopOverProps extends ExcludedTypes<PopoverProps, InternalPopOverProps>{
