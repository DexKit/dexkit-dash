...
export declare type ThemeName = 'Light' | 'Dark' | string;
...
export interface AccountManagerTable {
    ...
    getData(paginationLastId?: string | number): Promise<Array<{}>>;
}
...
export type ChartingLibraryWidgetConstructor = new (options: ChartingLibraryWidgetOptions | TradingTerminalWidgetOptions) => IChartingLibraryWidget;
...
export interface OrderDialogOptions {
    customFields?: Array<TextWithCheckboxFieldMetaInfo | CustomInputFieldMetaInfo>;
}
