...
export default {
    ...
    async resolveSymbol (symbolName: string, onSymbolResolvedCallback: any, onResolveErrorCallback: any){
   ...
   async getBars (symbolInfo: any, resolution: any, from: any, to: any, onHistoryCallback: any, onErrorCallback: any, first: any){
        try{
            ...
            const bars = response2.data.data.ethereum.dexTrades.map((el: any) => ({
