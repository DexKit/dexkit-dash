...
export const setAccounts =
  createAction<{accounts: UIAccount[]; type: SupportedNetworkType}>(
    'ui/ACCOUNTS_set',
  );
...
export const toggleWelcomeModal = createAction<void>('ui/WELCOME_MODAL_toggle');

export const setUserEncryptedSeed = createAction<string | undefined>(
  'ui/USER_ENCRYPTED_Seed_set',
);

export const setLoginBackRoute = createAction<string | undefined>(
  'ui/LOGIN_BACK_ROUTE',
);
