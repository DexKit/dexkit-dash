...
const TableItem: React.FC<TableItemProps> = ({row}) => {
  ...
  return (
    <TableRow key={row.address}>
      <TableCell align='left' className={classes.tableCell}><Link to={`/protocol-explorer/uniswap/pair-explorer/${row.address}`}>{row.baseToken.symbol}/{row.quoteToken.symbol}</Link></TableCell>
