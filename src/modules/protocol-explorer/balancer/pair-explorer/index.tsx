...
const PairExplorer: React.FC<Props> = (props) => {
  ...
  const {isLoadingInfo, infoData} = usePairExplorer(baseAddress, quoteAddress, EXCHANGE.BALANCER)
        ...
        <GridContainer>
          <Grid item xs={12} md={12}>
            <Breadcrumbs aria-label="breadcrumb">
              ...
              <Link color="inherit" href="/protocol-explorer/balancer/pair-explorer" >
               Balancer Protocol
              </Link>
          ...
          <Grid item xs={12} md={5}>
            <Grid item xs={12} md={12}>
                <Paper style={{ padding: 10 }}>
                  <TokenSearchByList url={`/protocol-explorer/balancer/pair-explorer`} type='pair'/>
                </Paper>
              </Grid>
            {
          ...
          <Grid style={{ marginTop: 20 }} item xs={12} md={12}>
            <TokenOrders baseAddress={baseAddress} quoteAddress={quoteAddress} exchange={EXCHANGE.BALANCER} type={'pair'} />
          </Grid>
