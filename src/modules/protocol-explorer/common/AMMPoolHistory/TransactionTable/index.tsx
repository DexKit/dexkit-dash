...
const TransactionTable: React.FC<Props> = ({transactionData, isLoading, total, page, perPage, onChangePage, onChangePerPage, exchange, networkName}) => {
  ...
  return (
    <Box className={classes.tableResponsiveMaterial}>
      <Table className='table'>
        ...
        <TableBody>
          {(transactionData.length > 1) && transactionData.map((data) => (
