...
const TableItem: React.FC<TableItemProps> = ({row}) => {
  ...
  return (
    <TableRow key={row.hash}>
      ...
      <TableCell align='left' className={classes.tableCell}><Link to={`/protocol-explorer/sushiswap/pair-explorer/${row.contract}`}>{row.baseToken.symbol}/{row.quoteToken.symbol}</Link></TableCell>
