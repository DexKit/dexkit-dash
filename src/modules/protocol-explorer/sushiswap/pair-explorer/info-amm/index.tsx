...
import {ETHERSCAN_API_URL, UNISWAP_INFO_API_URL, DEXTOOLS_API_URL, SUSHISWAP_INFO_API_URL} from '../../../../../shared/constants/AppConst';
        ...
        <Box display='flex' flexDirection='column'>
          ...
          <Box display='flex' flexDirection='row' justifyContent='space-between'>
            ...
            <Box display='flex'>
              ...
              <Box mr={3}>
                <a href={`${SUSHISWAP_INFO_API_URL}/pair/${props.data.address}`} target="_blank">
                  <Avatar style={{color: '#3F51B5', backgroundColor: 'white', width: 34, height: 34}} src="/images/sushiswap.png"></Avatar>
                </a>
              </Box>
              <Box mr={3}>
                <a href={`${DEXTOOLS_API_URL}/app/sushiswap/pair-explorer/${props.data.address}`} target="_blank" rel="noopener nofollow noreferrer">
