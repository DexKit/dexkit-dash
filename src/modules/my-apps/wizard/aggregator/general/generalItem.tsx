...
import { Checkbox, CircularProgress, FormControlLabel, Grid, InputAdornment, TextField } from '@material-ui/core';
...
export const ItemComponent: React.FC<ItemComponentProps> = (
  { fieldName, value: initialValue, changeField, validator, isValid: startValidation}: ItemComponentProps
) => {
