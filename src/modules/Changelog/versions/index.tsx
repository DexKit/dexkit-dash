        ...
        <Paper className={classes.root}>
           ...
           <Accordion defaultExpanded={true}>
            ...
            <Accordion>
                ...
                >
                    <Typography className={classes.heading}>v0.0.3 - 2-07-2021</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Box display={'flex'} flexDirection={'column'}>
                    <Typography className={classes.item}>
                        Added Transfer, Accept and make Offer on NFT wallets using OPEN Sea, Orders on Open Sea will show in
                    </Typography>
                    <Typography className={classes.item}>
                        Major Design/Refactor simplicity changes to integrate in a easy way BSC and ETH tokens in one place, and upcoming blockchains
                     </Typography>
                    <Typography className={classes.item}>
