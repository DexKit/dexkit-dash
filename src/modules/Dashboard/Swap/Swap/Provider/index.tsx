...
export const SwapContext = React.createContext<SwapContextProps>(defaultSwapContext);
...
const SwapContextProvider: React.FC<React.ReactNode> = ({children}) => {
  ...
  const [minFromAmount, setMinFromAmount] = useState<Number>(defaultSwapContext.minFromAmount)
  const [toAmount, setToAmount] = useState<Number>();
  const [addressToSend, setAddressToSend] = useState<string>();
  const [validAddress, setValidAddress] = useState<boolean>(defaultSwapContext.validAddress);


return <SwapContext.Provider
          value={{
            loading, 
            setLoading,
            toLoading,
