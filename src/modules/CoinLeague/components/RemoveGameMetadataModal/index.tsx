    ...
    <Dialog open={open}>
            ...
            <Grid container spacing={2} justifyContent={'flex-start'}>
              ...
              <Grid item>
                <Typography variant='h6' color='error'>
                  Are you sure you want to remove prize for game #{id}{' '}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
      ...
      <DialogContent dividers>
        <Grid container className={classes.innerContent} spacing={2}>
          ...
          <Grid item xs={12}>
            <Typography variant='subtitle2'>Title - {game.title}</Typography>
          </Grid>
          <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <Button
              ...
              startIcon={
                isSubmitting() ? (
                  <CircularProgress color='inherit' size={theme.spacing(7)} />
                ) : (
              ...
              {submitState === SubmitState.Confirmed ? (
                ...
                <IntlMessages id='app.coinLeague.errorRemovingMetadata' />
              ) : (
