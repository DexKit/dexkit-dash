    ...
    <Dialog open={open}>
      ...
      <DialogContent dividers>
        <Grid container className={classes.innerContent} spacing={5}>
          ...
          <Grid item xs={12}>
            <Typography variant='body1'>{gameMetadata?.description}</Typography>
          </Grid>

          <Grid item xs={12}>
            <Typography variant='body1'>
              Created By:{' '}
              {GET_CREATOR_LABELS(gameMetadata?.creator)
                ? GET_CREATOR_LABELS(gameMetadata?.creator)
                : truncateAddress(gameMetadata?.creator)}
            </Typography>
          </Grid>
        </Grid>
      </DialogContent>
