...
export const ColpaseTokenComponent: FC<ColpaseTokenComponentProps> = (
  props,
) => {
  const {
    tokens,
  ...
  return (
    <>
      {tokens != null
        ? tokens.map((token: TokenMetaData, i: number) => (
