...
export const TokenListComponent: FC<TokenListComponentProps> = (props) => {
  ...
  const helpText =
    'Enter the addresses of the tokens by secing them through ";"';
          ...
          <Grid item xs={10} md={12} sm={12} key={'lote-address'}>
            <Box display='flex'>
              <TextField
                ...
                fullWidth
                label={
                  <CustomLabel required={true}>Token Addresses</CustomLabel>
                }
                variant='outlined'
