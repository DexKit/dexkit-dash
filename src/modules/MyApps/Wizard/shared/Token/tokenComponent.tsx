...
export const TokenComponent: React.FC<TokenComponentProps> = (props) => {
        ...
        .then((token) => {
          if (token != null && address) {
            ...
            const _errors = {
              ...
              decimals: decimalsValidator(_decimals)
                ? undefined
                : 'Decimals number is invalid!',
            } as error;
  ...
  useEffect(() => {
    if (errors != null) {
      const _valid = Object.values(errors).reduce<boolean>(
        (pre, cur): boolean => Boolean(pre && cur == null),
        true,
      );
      setValid(_valid);
    }
      ...
      <Grid item xs={12} md={6} sm={6}>
        <TextField
          ...
          onBlur={() => {
            if (address) {
              ...
              if (!unique) {
                ...
                setErrors({
                  ...errors,
                  address: 'Collection address is invalid!',
                });
              }
            }
          }}
          ...
          InputProps={{
            endAdornment: (
              <InfoComponent
                text={getHelpText(HELP_TEXT_TOKEN, 'address', 0)}
              />
            ),
          }}
        />
      ...
      <Grid item xs={12} md={6} sm={6}>
        <TextField
          ...
          onBlur={() => {
            ...
            if (nameValidator(name)) setErrors({...errors, name: undefined});
            else setErrors({...errors, name: 'Token name is invalid!'});
          }}
          onChange={($e) => {
            if (!Boolean(editable)) {
              return;
          ...
          InputProps={{
            endAdornment: (
              <InfoComponent text={getHelpText(HELP_TEXT_TOKEN, 'name', 0)} />
            ),
          }}
        />
      </Grid>
      <Grid item xs={12} md={6} sm={6}>
        <TextField
          ...
          onBlur={() => {
            ...
            else setErrors({...errors, symbol: 'Symbol is invalid!'});
          }}
          onChange={($e) => {
            if (!Boolean(editable)) {
              return;
          ...
          InputProps={{
            endAdornment: (
              <InfoComponent text={getHelpText(HELP_TEXT_TOKEN, 'symbol', 0)} />
            ),
          }}
        />
      </Grid>
      <Grid item xs={12} md={6} sm={6}>
        <TextField
          ...
          InputProps={{
            endAdornment: (
              <InfoComponent
                text={getHelpText(HELP_TEXT_TOKEN, 'decimals', 0)}
              />
            ),
          }}
        />
