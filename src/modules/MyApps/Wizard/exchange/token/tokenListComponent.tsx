...
const placeHolder = `${truncateAddress(ZERO_ADDRESS.toString())};${truncateAddress('0x6b175474e89094c44da98b954eedeac495271d0f')};...`;
          ...
          <Grid item xs={10} md={12} sm={12} key={'lote-address'} >
            <Box display="flex">
              <TextField
                ...
                //     setError({ ['0']: 'Address field is invalid!' })
                //   } else {
                //     setError({ ['0']: undefined })
                //   }
                // }}
                onChange={
                  ($e) => {
