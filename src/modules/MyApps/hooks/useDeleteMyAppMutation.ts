      ...
      const msgParams: EIP712TypedData = {
        ...
        message: {
          message: intl.formatMessage(
            {
              id: 'myapps.deleteAggregator',
              defaultMessage: 'I want to delete app with domain {domain} ',
            },
            {domain: domain},
          ),
          ...
          return deleteConfig(dataToSend, account, domain)
            .then((c: any) => {
              const notification: CustomNotification = {
                title: intl.formatMessage({
                  id: 'myapps.deleteSuccessTitle',
                  defaultMessage: 'App deleted',
                }),
                body: intl.formatMessage({
                  id: 'myapps.deleteSuccessBody',
                  defaultMessage: 'App was deleted',
                }),
              };
            ...
            .catch(() => {
              const notification: CustomNotification = {
                title: 'Error',
                body: intl.formatMessage({
                  id: 'myapps.deleteErrorBody',
                  defaultMessage: 'Error deleting your app, contact support',
                }),
              };
              dispatch(onAddNotification([notification]));
